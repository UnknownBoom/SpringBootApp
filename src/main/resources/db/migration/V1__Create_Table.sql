...
create table specification_material (id bigint not null, amount integer not null, material varchar(255), product_type varchar(255), primary key (id)) engine=InnoDB;
...
create table specification_operation (id bigint not null, equipment_type varchar(255), operation varchar(255), operation_time integer not null, product_type varchar(255), primary key (id)) engine=InnoDB;
...
alter table specification_material add constraint UK_sh3acgam0lsq44wgs3tvjhxoj unique (material, product_type);
